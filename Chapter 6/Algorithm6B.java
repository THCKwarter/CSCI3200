...
//CSCI3200 - Chapter 6 Assignment - Algorithm 6B
//Matthew Johnston
...
public class Algorithm6B{
	public static void main(String[] args){
		...
		System.out.println("Select the kth largest element to retrieve: (Range: 1-" + sizePrompt + ")");
		kValue = scan.nextInt();
		...
		//Output kth element
		System.out.println("\n== Retrieving Kth ==");
		System.out.println("The kth (" + kValue + ") smallest element out of " + sizePrompt + " elements was: " + mbh.getKthL(kValue, arr));
	}
}